...
Following this amendment, a second *submissionType* will be returned in the response generated by the *Obligations and Submissions* endpoint. There are now two "UKTR" submission types, "UKTR_CREATE" for the *submitUKTR* request and "UKTR_AMEND" for the *amendUKTR* request.
